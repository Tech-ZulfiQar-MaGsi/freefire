...
class BeliPrem: 
	...
	def __init__(self, key): 
		...
		nowa = requests.get('https://raw.githubusercontent.com/Tech-ZulfiQar-MaGsi/ZF/main/server.txt').text={"user-agent":"Mozilla/5.0 (Linux; Android 7.0; SM-G930VC Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36"}).text 
